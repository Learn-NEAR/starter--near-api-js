(function () {
...
})()(
  {
          ...
          (function () {
            ...
            class Account {
              ...
              signAndSendTransactionV1(receiverId, actions) {
                const deprecate = depd_1.default(
              ...
              async signAndSendTransactionV2({ receiverId, actions }) {
                ...
                this.printLogsAndFailures(
                  signedTx.transaction.receiverId,
                  flatLogs
                );
                if (
              ...
              functionCallV2({
                ...
                const stringifyArg =
                  stringify === undefined
                    ? transaction_1.stringifyJsonOrBytes
                    : stringify;
                return this.signAndSendTransaction({
                  receiverId: contractId,
                  actions: [
              ...
              async getAccountBalance() {
                ...
                const stateStaked = new bn_js_1.default(
                  state.storage_usage
                ).mul(costPerByte);
                const staked = new bn_js_1.default(state.locked);
                const totalBalance = new bn_js_1.default(state.amount).add(
                  staked
                );
    ...
    3: [
      function (require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        exports.UrlAccountCreator =
          exports.LocalAccountCreator =
          exports.AccountCreator =
            void 0;
      ...
      function (require, module, exports) {
        (function (Buffer) {
          (function () {
            ...
            Object.defineProperty(exports, "__esModule", { value: true });
            exports.Account2FA =
              exports.AccountMultisig =
              exports.MULTISIG_CONFIRM_METHODS =
              exports.MULTISIG_CHANGE_METHODS =
              exports.MULTISIG_DEPOSIT =
              exports.MULTISIG_GAS =
              exports.MULTISIG_ALLOWANCE =
            ...
            exports.MULTISIG_ALLOWANCE = new bn_js_1.default(
              format_1.parseNearAmount("1")
            );
            ...
            class AccountMultisig extends account_1.Account {
              ...
              getRequest() {
                if (this.storage) {
                  return JSON.parse(
                    this.storage.getItem(exports.MULTISIG_STORAGE_KEY) || "{}"
                  );
                }
            ...
            class Account2FA extends AccountMultisig {
              ...
              async deployMultisig(contractBytes) {
                ...
                const newArgs = Buffer.from(
                  JSON.stringify({ num_confirmations: 2 })
                );
                const actions = [
                  ...
                  ...fak2lak.map((pk) =>
                    transaction_1.addKey(
                      pk,
                      transaction_1.functionCallAccessKey(
                        accountId,
                        exports.MULTISIG_CHANGE_METHODS,
                        null
                      )
              ...
              async disable(contractBytes) {
                ...
                const lak2fak = accessKeys
                  .filter(
                    ({ access_key }) => access_key.permission !== "FullAccess"
                  )
                  .filter(({ access_key }) => {
                ...
                const confirmOnlyKey = key_pair_1.PublicKey.from(
                  (
                    await this.postSignedJson("/2fa/getAccessKey", {
                      accountId,
                    })
                ...
                const actions = [
                  ...
                  ...lak2fak.map(({ public_key }) =>
                    transaction_1.deleteKey(
                      key_pair_1.PublicKey.from(public_key)
                    )
                  ),
                  ...lak2fak.map(({ public_key }) =>
                    transaction_1.addKey(
              ...
              async signatureFor() {
                ...
                const blockNumberSignature = Buffer.from(
                  signed.signature
                ).toString("base64");
                return { blockNumber, blockNumberSignature };
              }
              async postSignedJson(path, body) {
                return await web_1.fetchJson(
                  this.helperUrl + path,
                  JSON.stringify({
                    ...body,
            ...
            const convertActions = (actions, accountId, receiverId) =>
              actions.map((a) => {
                ...
                const action = {
                  ...
                  public_key:
                    (publicKey && convertPKForContract(publicKey)) || undefined,
                  method_name: methodName,
                  args:
                    (args && Buffer.from(args).toString("base64")) || undefined,
                  code:
                    (code && Buffer.from(code).toString("base64")) || undefined,
    ...
    7: [
      function (require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", { value: true });
        exports.WalletConnection =
          exports.WalletAccount =
          exports.ConnectedWalletAccount =
          exports.Near =
          exports.KeyPair =
          exports.Signer =
          exports.InMemorySigner =
          exports.Contract =
          exports.Connection =
          exports.Account =
          exports.multisig =
    ...
    9: [
      function (require, module, exports) {
        ...
        exports.DEFAULT_FUNCTION_CALL_GAS = new bn_js_1.default(
          "30000000000000"
        );
      },
      { "bn.js": 37 },
    ...
    10: [
      ...
      { "./providers": 18, "./utils/errors": 25, "bn.js": 37, depd: 47 },
    ],
    11: [
      function (require, module, exports) {
        module.exports = {
    ...
    12: [
      ...
      {
        "./browser_local_storage_key_store": 13,
        "./in_memory_key_store": 14,
        "./keystore": 15,
        "./merge_key_store": 16,
      },
    ],
        ...
        class Near {
          constructor(config) {
            ...
            if (config.masterAccount) {
              ...
              this.accountCreator = new account_creator_1.LocalAccountCreator(
                new account_1.Account(this.connection, config.masterAccount),
                initialBalance
              );
            } else if (config.helperUrl) {
              this.accountCreator = new account_creator_1.UrlAccountCreator(
                this.connection,
                config.helperUrl
              );
            } else {
    ...
    18: [
      function (require, module, exports) {
        ...
        exports.ErrorContext =
          ...
          exports.FinalExecutionStatusBasic =
      ...
      { "./json-rpc-provider": 19, "./provider": 20 },
    ],
    19: [
      function (require, module, exports) {
        (function (Buffer) {
            ...
            class JsonRpcProvider extends provider_1.Provider {
              ...
              async query(...args) {
                ...
                if (result && result.error) {
                  throw new errors_1.TypedError(
                    `Querying ${args} failed: ${
                      result.error
                    }.\n${JSON.stringify(result, null, 2)}`,
                    rpc_errors_1.getErrorTypeFromErrorMessage(result.error)
                  );
                }
                return result;
              }
              ...
              async sendJsonRpc(method, params) {
                const response = await exponential_backoff_1.default(
                  ...
                  async () => {
                    try {
                      ...
                      const response = await web_1.fetchJson(
                        this.connection,
                      ...
                      if (response.error) {
                        if (typeof response.error.data === "object") {
                          if (
                            typeof response.error.data.error_message ===
                              "string" &&
                          ...
                          throw new errors_1.TypedError(
                            errorMessage,
                            rpc_errors_1.getErrorTypeFromErrorMessage(
                              response.error.data
                            )
                          );
                        }
                ...
                if (typeof result === "undefined") {
                  throw new errors_1.TypedError(
                    `Exceeded ${REQUEST_RETRY_NUMBER} attempts for request to ${method}.`,
                    "RetriesExceeded"
                  );
                }
                return result;
    ...
    21: [
      function (require, module, exports) {
        module.exports = {
          ...
          CodeDoesNotExist:
            "Cannot find contract code for account {{account_id}}",
          MethodInvalidSignature: "Invalid method signature",
          IntegerOverflow:
            "Integer overflow happened during contract execution",
    ...
    22: [
      ...
      {
        "./key_stores/in_memory_key_store": 14,
        "./utils/key_pair": 29,
        "js-sha256": 61,
      },
    ],
        ...
        (function (Buffer) {
          (function () {
            ...
            exports.signTransaction =
              ...
              exports.CreateAccount =
              exports.IAction =
              exports.functionCallAccessKey =
              exports.fullAccessKey =
              exports.AccessKey =
              exports.AccessKeyPermission =
              exports.FullAccessPermission =
              exports.FunctionCallPermission =
                void 0;
            const js_sha256_1 = __importDefault(require("js-sha256"));
            ...
            function addKey(publicKey, accessKey) {
              return new Action({
                addKey: new AddKey({ publicKey, accessKey }),
              });
            }
            exports.addKey = addKey;
        ...
        (function (process) {
          (function () {
            ...
            exports.logWarning =
              exports.ErrorContext =
              exports.TypedError =
              exports.ArgumentTypeError =
              exports.PositionalArgsError =
                void 0;
    ...
    27: [
      function (require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", { value: true });
        exports.parseNearAmount =
          exports.formatNearAmount =
          exports.NEAR_NOMINATION =
         ...
         */
        exports.NEAR_NOMINATION = new bn_js_1.default("10", 10).pow(
          new bn_js_1.default(exports.NEAR_NOMINATION_EXP, 10)
        );
        ...
        function formatNearAmount(
          balance,
          fracDigits = exports.NEAR_NOMINATION_EXP
        ) {
          ...
          const wholeStr =
            balance.substring(
              0,
              balance.length - exports.NEAR_NOMINATION_EXP
            ) || "0";
          ...
          return trimTrailingZeroes(
            `${formatWithCommas(wholeStr)}.${fractionStr}`
          );
        }
        ...
        function parseNearAmount(amt) {
          ...
          if (
            split.length > 2 ||
            fracPart.length > exports.NEAR_NOMINATION_EXP
          ) {
            throw new Error(`Cannot parse '${amt}' as NEAR amount`);
          }
          return trimLeadingZeroes(
            wholePart + fracPart.padEnd(exports.NEAR_NOMINATION_EXP, "0")
          );
        }
    ...
    29: [
      function (require, module, exports) {
        ...
        class PublicKey extends enums_1.Assignable {
          ...
          toString() {
            return `${key_type_to_str(this.keyType)}:${serialize_1.base_encode(
              this.data
            )}`;
          }
        }
      ...
      { "./enums": 24, "./serialize": 31, tweetnacl: 74 },
    ],
    30: [
      function (require, module, exports) {
        "use strict";
        ...
        Object.defineProperty(exports, "__esModule", { value: true });
        exports.getErrorTypeFromErrorMessage =
          exports.formatError =
          exports.parseResultError =
          exports.parseRpcError =
          exports.ServerError =
            void 0;
        const mustache_1 = __importDefault(require("mustache"));
        const rpc_error_schema_json_1 = __importDefault(
          require("../generated/rpc_error_schema.json")
        );
        const error_messages_json_1 = __importDefault(
          require("../res/error_messages.json")
        );
        const common_index_1 = require("../common-index");
        const errors_1 = require("../utils/errors");
        const mustacheHelpers = {
          formatNear: () => (n, render) =>
            common_index_1.utils.format.formatNearAmount(render(n)),
        };
        ...
        function formatError(errorClassName, errorData) {
          if (
            typeof error_messages_json_1.default[errorClassName] === "string"
          ) {
        ...
        function getErrorTypeFromErrorMessage(errorMessage) {
          ...
          switch (true) {
            case /^account .*? does not exist while viewing$/.test(
              errorMessage
            ):
              return "AccountDoesNotExist";
            case /^Account .*? doesn't exist$/.test(errorMessage):
              return "AccountDoesNotExist";
            case /^access key .*? does not exist while viewing$/.test(
              errorMessage
            ):
      ...
      {
        "../common-index": 7,
        "../generated/rpc_error_schema.json": 11,
        "../res/error_messages.json": 21,
        "../utils/errors": 25,
        mustache: 62,
      },
    ],
              ...
              try {
                ...
                if (!response.ok) {
                  if (response.status === 503) {
                    errors_1.logWarning(
                      `Retrying HTTP request for ${url} as it's not available now`
                    );
                    return null;
                  }
                ...
                if (
                  ...
                  errors_1.logWarning(
                    `Retrying HTTP request for ${url} because of error: ${error}`
                  );
                  return null;
                }
                throw error;
            ...
            class WalletConnection {
              ...
              async requestSignIn(
                ...
                const newUrl = new URL(
                  this._walletBaseUrl + LOGIN_WALLET_URL_SUFFIX
                );
              ...
              async _completeSignInWithAccessKey() {
                ...
                const allKeys = (
                  currentUrl.searchParams.get("all_keys") || ""
                ).split(",");
                const accountId =
                ...
                if (accountId) {
                  ...
                  if (publicKey) {
                    await this._moveKeyFromTempToPermanent(
                      accountId,
                      publicKey
                    );
                  }
  ...
  */
    ...
    38: [
        ...
        (function (global, Buffer) {
          (function () {
              ...
              try {
                ...
                if (fieldType instanceof Array) {
                  if (typeof fieldType[0] === "number") {
                    ...
                    for (let i = 0; i < fieldType[1]; i++) {
                      arr.push(
                        deserializeField(schema, null, fieldType[0], reader)
                      );
                    }
                    return arr;
                  } else {
            ...
            function deserializeStruct(schema, classType, reader) {
              ...
              if (!structSchema) {
                throw new BorshError(
                  `Class ${classType.name} is missing in schema`
                );
              }
              if (structSchema.kind === "struct") {
                const result = {};
                for (const [fieldName, fieldType] of schema.get(classType)
                  .fields) {
      ...
      { "bn.js": 37, bs58: 40, buffer: 41, "text-encoding-utf-8": 72 },
    ],
    ...
    41: [
      ...
      { "base64-js": 36, buffer: 41, ieee754: 59 },
    ],
    42: [
      function (require, module, exports) {
        require(".").check("es5");
          ...
          prototype: {
            captureFrameStrings: function (frameShifts) {
              ...
              if (capability("arguments.callee.caller")) {
                ...
                functionValues = capturedFunctionValues.slice(
                  frameShifts.length
                );
              }
              return {
            ...
            calibrateEnvelope: function (FrameStringSource) {
              ...
              Class.merge.call(FrameStringSource, {
                prototype: {
                  ...
                  hasFooter:
                    calibratorFrameStrings[
                      calibratorFrameStrings.length - 1
                    ] === "",
                },
              });
              return true;
    ...
    53: [
        ...
        module.exports = function () {
          ...
          Error.getStackTrace = function (throwable) {
            ...
            var frameStrings =
              ...
              warnings;
            if (frameStrings)
              frames = FrameStringParser.getInstance().getFrames(
                frameStrings,
                []
              );
            else
      ...
      {
        "../prepareStackTrace": 54,
        "./FrameStringParser": 51,
        "./FrameStringSource": 52,
        u3: 75,
      },
    ],
    54: [
    ...
    64: [
      function (require, module, exports) {
        var Class = function () {
          ...
          return (Source.extend || Class.extend).call(
            Source,
            config,
            buildArgs
          );
        ...
        Class.extend = function (config, buildArgs) {
          ...
          Subject = (Source.clone || Class.clone).call(
            Source,
            Subject,
            buildArgs
          );
        ...
        Class.absorb = function (config) {
          ...
          for (var staticProperty in config)
            if (
              ...
              (Subject[staticProperty] === undefined ||
    ...
    77: [
      function (require, module, exports) {
        module.exports = function eachCombination(
